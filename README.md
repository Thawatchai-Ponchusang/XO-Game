...
2. **การสมัคร Firebase**:
	โปรเจ็กนี้ใช้ database แบบ Realtime ของ Firebase หากยังไม่มี Firebase แนะนำให้สมัครได้ที่ [Firebase | Google's Mobile and Web App Development Platform](https://firebase.google.com/) หลังจากสร้าง Account และสร้างโปรเจ็กเรียบร้อยแล้ว ให้สร้าง database แบบ Realtime เพื่อที่จะนำคีย์ต่าง ๆ มาใส่ตามโค้ดที่อยู่ด้านล่าง
```js
...
1. **โฮสต์เว็บไซต์ได้เลย**:
   หลังจากที่ดาวน์โหลด file ต่าง ๆ ใน github แล้วสามารถโฮสต์เว็บไซต์ผ่านโปรแกรมที่มีได้เลย ยกตัวอย่างเช่น Xampp
...
* เมื่อเกมจบลง จะแสดงผลผู้ชนะหรือเสมอ และบันทึกข้อมูลเกมลงในฐานข้อมูล
